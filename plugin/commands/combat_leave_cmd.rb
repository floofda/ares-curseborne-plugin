  ...
  module CoD
    class CombatLeaveCmd
      ...
      def handle
        ...
        return CoD.system_emit(t('cod.not_in_combat'), client) if !CoD.is_combatant? combat, enactor

        CoD.remove_combatant combat, enactor
        CoD.system_emit t('cod.x_has_left_combat', name: enactor_name), client, enactor_room, :info
      end
    end
  end
end
